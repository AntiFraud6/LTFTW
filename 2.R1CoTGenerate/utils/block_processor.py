...
def create_blocks(dialogues: List[Dict], block_size: int = 5) -> List[List[Dict]]:
    """将对话按block_size分割成块"""
    blocks = []
...
def process_sample(sample_path: str, block_size: int = 5, history_blocks: int = 2) -> List[Dict]:
